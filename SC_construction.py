...
if __name__ == '__main__':
    ...
    for e in range(epoch_len):
        ...
        for im, label in train_loader:
            ...
            # print('shape of classification results:', out_codebook.size())
            # print('shape of labels:', label.size())
            # print('max of classification results:', torch.max(out_codebook))
            # print('min of classification results:', torch.min(out_codebook))
            # print('*' * 100) 
            # print('labels:', label)
            # print('classification results:', out_codebook)
            # print('*' * 100)
